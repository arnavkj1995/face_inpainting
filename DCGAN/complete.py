...
from model_for_youtube import DCGAN
...
flags.DEFINE_string('outDir', 'webcam_dcgan_128', "Directory to save completed images.")
flags.DEFINE_string('maskType', 'freehand_poly', 'maskType')
flags.DEFINE_float('centerScale', 0.25, 'centerScale')
flags.DEFINE_float('fraction_masked', 0.75, 'fraction_masked')
