...
from model_for_saving import DCGAN
from utils import pp

import tensorflow as tf

flags = tf.app.flags
flags.DEFINE_integer("lam", 0.1, "weight of perceptual loss")
...
flags.DEFINE_integer("decay_step", 100, "Decay step of learning rate in epochs")
